...
run_pixel = lambda do |ctx, out|
  ...
  u = ctx.uniforms
  g = {}
  map__float_float_float_float_float = pcg__uvec3 = prng__vec3 = brightnessContrast__vec3 = hsv2rgb__vec3 = rgb2hsv__vec3 = linearToSrgb__vec3 = oklab_from_linear_srgb__vec3 = linear_srgb_from_oklab__vec3 = periodicFunction__float = mod289__vec3 = mod289__vec2 = permute__vec3 = simplexValue__vec2_float_float_float_float = sineNoise__vec2_float_float_float_float = positiveModulo__int_int = randomFromLatticeWithOffset__vec2_float_float_float_ivec2 = constant__vec2_float_float_float = constantOffset__vec2_float_float_float_ivec2 = quadratic3__float_float_float_float = catmullRom3__float_float_float_float = quadratic3x3Value__vec2_float_float_float = catmullRom3x3Value__vec2_float_float_float = blendBicubic__float_float_float_float_float = catmullRom4__float_float_float_float_float = blendLinearOrCosine__float_float_float_int = bicubicValue__vec2_float_float_float = catmullRom4x4Value__vec2_float_float_float = value__vec2_float_float_float = main__void = nil
  _retc = nil
  ...
  sineNoise__vec2_float_float_float_float = lambda do |st, xFreq, yFreq, s, blend|
    ...
    r1 = rt.binary('+', rt.binary('*', prng__vec3.call(rt.construct(3, s, rt.f(0), rt.f(0))), rt.f(0.75), 3, 'float'), rt.f(0.125), 3, 'float')
    r2 = rt.binary('+', rt.binary('*', prng__vec3.call(rt.construct(3, rt.binary('+', s, rt.f(10), 1, 'float'), rt.f(0), rt.f(0))), rt.f(0.75), 3, 'float'), rt.f(0.125), 3, 'float')
  ...
  main__void = lambda do
    color = nil; globalCoord = nil; ref = nil; s = nil; st = nil; uv = nil; xFreq = nil; xRef = nil; yFreq = nil; yRef = nil
    ...
    yFreq = rt.f(1)
    if rt.bool(rt.binary('==', _u__NOISE_TYPE, rt.i(10)))
      xFreq = map__float_float_float_float_float.call(_u_noiseScale, rt.f(1), rt.f(100), rt.f(1), rt.f(0.25))
      yFreq = rt.binary('*', xFreq, rt.f(1.5), 1, 'float')
    else
      if rt.bool(rt.binary('==', _u__NOISE_TYPE, rt.i(4)))
        xFreq = map__float_float_float_float_float.call(_u_noiseScale, rt.f(1), rt.f(100), rt.f(1.5), rt.f(1))
        yFreq = rt.binary('*', xFreq, rt.f(1.5), 1, 'float')
      else
        if rt.bool(_u_wrap)
          xFreq = rt.component_wise('floor', map__float_float_float_float_float.call(_u_noiseScale, rt.f(1), rt.f(100), rt.f(3), rt.f(2)))
          yFreq = xFreq
        else
          xFreq = map__float_float_float_float_float.call(_u_noiseScale, rt.f(1), rt.f(100), rt.f(1.5), rt.f(1))
          yFreq = rt.binary('*', xFreq, rt.f(1.5), 1, 'float')
    ...
    xRef = value__vec2_float_float_float.call(st, xFreq, yFreq, rt.binary('+', rt.unary('+', rt.f(20)), s, 1, 'float'))
    yRef = value__vec2_float_float_float.call(st, xFreq, yFreq, rt.binary('+', rt.unary('+', rt.f(10)), s, 1, 'float'))
    ref = map__float_float_float_float_float.call(_u_refractAmt, rt.f(0), rt.f(100), rt.f(0), rt.f(2.5))
    ...
    if rt.bool(rt.binary('==', _u__COLOR_MODE, rt.i(0)))
      color = rt.assign_swizzle(color, 'rgb', rt.construct(3, value__vec2_float_float_float.call(uv, xFreq, yFreq, s)))
    else
      color.replace((rt.construct(4, value__vec2_float_float_float.call(uv, xFreq, yFreq, s), value__vec2_float_float_float.call(uv, xFreq, yFreq, rt.binary('+', rt.f(10), s, 1, 'float')), value__vec2_float_float_float.call(uv, xFreq, yFreq, rt.binary('+', rt.f(20), s, 1, 'float')), rt.f(1))).map { |c| rt.f32(c) })
    end
    if rt.bool(rt.binary('==', _u__COLOR_MODE, rt.i(0)))
      if rt.bool(_u_ridges)
        color.replace((rt.binary('-', rt.f(1), rt.component_wise('abs', rt.binary('-', rt.binary('*', color, rt.f(2), 4, 'float'), rt.f(1), 4, 'float')), 4, 'float')).map { |c| rt.f32(c) })
      end
    else
