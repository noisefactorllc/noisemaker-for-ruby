...
run_pixel = lambda do |ctx, out|
  ...
  compute_simplex_value__vec2_vec2_float_float_vec3 = lambda do |coord, freq, _t, speed_value, offset|
    ...
    sampleVec = rt.construct(3, rt.construct(3, rt.binary('+', rt.binary('*', rt.swizzle(coord, 'x'), freq_x, 1, 'float'), rt.swizzle(offset, 'x'), 1, 'float'), rt.binary('+', rt.binary('*', rt.swizzle(coord, 'y'), freq_y, 1, 'float'), rt.swizzle(offset, 'y'), 1, 'float'), rt.binary('+', angle, rt.swizzle(offset, 'z'), 1, 'float')))
  ...
  vhs_computeNoise__vec2_vec2_float_float_vec3_vec3 = lambda do |coord, freq, _t, spd, baseOff, timeOff|
    ...
    if rt.bool((rt.bool(rt.binary('!=', spd, rt.f(0))) && rt.bool(rt.binary('!=', _t, rt.f(0))) ? 1 : 0))
      tp = rt.construct(3, rt.construct(3, rt.binary('+', rt.binary('*', rt.swizzle(coord, 'x'), rt.swizzle(freq, 'x'), 1, 'float'), rt.swizzle(timeOff, 'x'), 1, 'float'), rt.binary('+', rt.binary('*', rt.swizzle(coord, 'y'), rt.swizzle(freq, 'y'), 1, 'float'), rt.swizzle(timeOff, 'y'), 1, 'float'), rt.swizzle(timeOff, 'z')))
  ...
  main__void = lambda do
    ...
    globalGid_f = rt.construct(2, rt.construct(2, rt.binary('+', rt.construct(1, rt.swizzle(gid, 'x')), rt.swizzle(_u_tileOffset, 'x'), 1, 'float'), rt.binary('+', rt.construct(1, rt.swizzle(gid, 'y')), rt.swizzle(_u_tileOffset, 'y'), 1, 'float')))
    ...
    if rt.bool(rt.binary('==', m, rt.i(1)))
      ...
      destCoord = rt.construct(2, rt.construct(2, xNorm, yNorm))
