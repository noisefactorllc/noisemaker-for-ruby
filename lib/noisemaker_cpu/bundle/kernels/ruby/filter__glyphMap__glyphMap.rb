...
run_pixel = lambda do |ctx, out|
  ...
  main__void = lambda do
    ...
    cellIndex = rt.construct(2, rt.component_wise('floor', rt.binary('/', pixelCoord, csf, 2, 'float')))
    localPos = rt.construct(2, rt.component_wise('fract', rt.binary('/', pixelCoord, csf, 2, 'float')))
    ...
    srcColor = rt.construct(4, rt.texture(_u_inputTex, sampleUV))
