...
run_pixel = lambda do |ctx, out|
  ...
  main__void = lambda do
    ...
    base_dist = rt.f(0.0)
    _retc, base_cell, base_dist = voronoiCell__vec2_float_float_vec3_float.call(uv, seed_f, _t, base_cell, base_dist)
    ...
    warp_dist = rt.f(0.0)
    _retc, warp_cell, warp_dist = voronoiCell__vec2_float_float_vec3_float.call(warped_uv, seed_f, _t, warp_cell, warp_dist)
