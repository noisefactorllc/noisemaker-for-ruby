...
run_pixel = lambda do |ctx, out|
  ...
  rotate2D__vec2_float = lambda do |st, rot|
    ...
    st.replace((rt.binary('-', st, rt.construct(2, rt.binary('-', rt.f(0.5), rt.binary('/', rt.swizzle(_u_fullResolution, 'x'), rt.swizzle(_u_fullResolution, 'y'), 1, 'float'), 1, 'float'), rt.f(0.5)), 2, 'float')).map { |c| rt.f32(c) })
  ...
  offset__vec2_float_int_float_float = lambda do |st, freq, loopOffset, speed, seed|
    st = rt.copy(st, 'float')
            ...
            if rt.bool(rt.binary('==', loopOffset, rt.i(200)))
              ...
              if rt.bool(rt.binary('==', loopOffset, rt.i(210)))
                ...
                if rt.bool((rt.bool(rt.binary('>=', loopOffset, rt.i(300))) && rt.bool(rt.binary('<=', loopOffset, rt.i(380))) ? 1 : 0))
                  ...
                  return rt.binary('-', rt.f(1), value__vec2_float_int_float.call(rt.binary('+', st, seed, 2, 'float'), f, interp, speed), 1, 'float')
                else
